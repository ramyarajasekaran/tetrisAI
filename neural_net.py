...
Press space to continue""")
			...
			tileState=(self.stone,(self.stone_x, self.stone_y))
				# engineer board features if desired

			###INSERT NEURAL NET ACTUATION
				# flatten inputs above and pass into NN
			#OUTPUTS
			out=0 #insert nn output here
			# run action
...
#----- neural net stuff starts here-----
def neural_net_magic(grid, piece, xpos, ypos):
